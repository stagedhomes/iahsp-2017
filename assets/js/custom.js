...
jQuery(document).ready(function($) {
    ...
    var $latitude = 47.998276, //If you unable to find latitude and longitude of your address. Please visit http://www.latlong.net/convert-address-to-lat-long.html you can easily generate.
        $longitude = -122.439503,
        $map_zoom = 9; /* ZOOM SETTING */

    //google map custom marker icon - .png fallback for IE11
    var is_internetExplorer11 = navigator.userAgent.toLowerCase().indexOf('trident') > -1;
    var $marker_url = (is_internetExplorer11) ? 'assets/images/map-marker.png' : 'assets/images/map-marker.svg';
